...
class CornersProblem(search.SearchProblem):
    ...
    def __init__(self, startingGameState):
        ...
        cornersLeft = self.corners
        self.startSpace = (self.startingPosition, cornersLeft)
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if (hitsWall == False):
                ...
                if (newCornersLeft.count((nextx,nexty)) != 0):
                    newCornersLeft.remove((nextx,nexty))
                successors.append((((nextx, nexty), tuple(newCornersLeft)), action, 1))            
